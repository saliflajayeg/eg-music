...
const s = {
  ...
  info: { padding:'12px 12px 4px', flex:1 },
  title: {
    fontSize:14, fontWeight:600, marginBottom:4,
    overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap',
    color:'var(--text)',
  },
  artist: { fontSize:12, color:'var(--accent2)', display:'block', marginBottom:4 },
  genre: {
    display:'inline-block', fontSize:10, fontWeight:600,
    background:'var(--bg3)', color:'var(--text3)',
    padding:'2px 7px', borderRadius:10, letterSpacing:.5,
  },
  meta: { display:'flex', gap:12, fontSize:11, color:'var(--text3)', marginTop:6 },
  actions: { display:'flex', alignItems:'center', justifyContent:'space-between', padding:'6px 12px 10px' },
  likeBtn: { fontSize:16, transition:'color .15s', fontWeight:600 },
